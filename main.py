...
def save_training_results(run_dir, model, train_losses_list, least_loss_tick_list, most_certain_tick_list):
    ...
    return model_path, full_model_path, metrics_path, final_model_info_path
...
if __name__ == "__main__":
    ...
    model, (train_losses_list, least_loss_tick_list, most_certain_tick_list) = train(
        model=model, 
    ...
    model_path, full_model_path, metrics_path, final_model_info_path = save_training_results(
